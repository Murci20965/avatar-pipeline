...
2. Create a .env file and add your AI key: GROQ\_API\_KEY=your\_key\_here  
...
2. Create a .env.local file and link the API: NEXT\_PUBLIC\_API\_URL=http://localhost:7860  
